...
from config import VICUNA_PATH, LLAMA_PATH, GENERATOR_TEMP, GENERATOR_TOP_P, LLAMA_LORA_MODEL,LORA_WEIGHTS
...
class GenatorLM():
    ...
    def get_response(self, convs_list, prompts_list):
        ...
        print("*******************convs_list[0].messages**********************\n",convs_list[0].messages,
              "\n************************************convs_list[0].messages******************************")

        if len(convs_list[0].messages) == 0:
            init_message = """{\"reason\": <reason>ERROR</reason>  \"\",\"score\": <score>ERROR</score>\"}"""
        else:
            init_message = """{\"reason\": \""""
